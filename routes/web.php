...
Route::group(['middleware' => ['verified']], function () {
    ...
    Route::get('/get_notif/{id}', [DashboardController::class, 'getNotif'])->name('get_notif.dashboard')->middleware(['auth','XSS', 'revalidate']);
    Route::get('/data_update/{id}/{clcik}/{deal_id}', [DashboardController::class, 'dataUpdate'])->name('data_update.dashboard')->middleware(['auth','XSS', 'revalidate']);
    ...
    Route::get('dealbypipeline/{id}' ,[DealController::class ,'getPipeline'] )->name('deal.pipeline')->middleware(['auth', 'XSS']);
    Route::get('deals/get_total/{id}' ,[DealController::class ,'getTotal'] )->name('deal.gettotal')->middleware(['auth', 'XSS']);
    Route::post('/deals/filterSearch', [DealController::class, 'getDealByUsers'])->name('deals.filterSearch')->middleware(['auth', 'XSS']);
    ...
    Route::post('/leads/newjson', [LeadController::class, 'newJson'])->name('leads.newjson');
    ...
    Route::get('/leads/{id}/priority', [LeadController::class, 'priority'])->name('leads.priority')->middleware(['auth', 'XSS']);
    Route::post('/leads/{id}/priority', [LeadController::class, 'priorityStore'])->name('leads.priority.store')->middleware(['auth', 'XSS']);
    ...
    Route::post('/leads/search', [LeadController::class, 'searchLead'])->name('leads.search')->middleware(['auth', 'XSS']);
    Route::get('/leads/filter', [LeadController::class, 'filterByUsers'])->name('leads.filter')->middleware(['auth', 'XSS']);
    Route::post('/leads/filterSearch', [LeadController::class, 'getLeadByUsers'])->name('leads.filterSearch')->middleware(['auth', 'XSS']);
    Route::post('/leads/getService', [LeadController::class, 'getService'])->name('leads.getService')->middleware(['auth', 'XSS']);
    Route::post('/leads/getClientData', [LeadController::class, 'getClientData'])->name('leads.getClientData')->middleware(['auth', 'XSS']);
    Route::get('/leads/{id}/transfer', [LeadController::class, 'transfer'])->name('leads.transfer')->middleware(['auth', 'XSS']);
    Route::get('/leads/{id}/getsourses', [LeadController::class, 'getSourses'])->name('leads.getsourses')->middleware(['auth', 'XSS']);
    Route::get('/leads/{id}/getserviceinfo', [LeadController::class, 'getServiceInfo'])->name('leads.getserviceinfo')->middleware(['auth', 'XSS']);
    Route::get('/leads/{id}/editserviceinfo/{lead_id}', [LeadController::class, 'editServiceInfo'])->name('leads.editserviceinfo')->middleware(['auth', 'XSS']);
    Route::post('/leads/{id}/is_transfered', [LeadController::class, 'is_transfered'])->name('leads.is_transfered')->middleware(['auth', 'XSS']);
    Route::post('/leads/{id}/reject', [LeadController::class, 'reject'])->name('leads.is_reject')->middleware(['auth', 'XSS']);
    ...
    Route::resource('leads', LeadController::class)->middleware(['auth', 'XSS']);
       ...
       // Get Pipeline for deal
       Route::post('leadbypipeline/' ,[LeadController::class ,'getPipeline'] )->name('lead.pipeline')->middleware(['auth', 'XSS']);
    ...
    Route::get('reports-commission', [ReportController::class, 'reportCommission'])->name('report.commission')->middleware(['auth', 'XSS']);
...
//    Route::get('timesheet-table-view', [TimesheetController::class, 'filterTimesheetTableView'])->name('filter.timesheet.table.view')->middleware(['auth', 'XSS']);
    ...
    Route::get('/contract/dealStatus/{id}', [ContractController::class, 'dealStatus'])->name('contract.dealStatus')->middleware(['auth']);
    Route::post('/contract/statusUpdate/{id}', [ContractController::class, 'statusUpdate'])->name('contract.statusUpdate')->middleware(['auth']);
    ...
    Route::get('export/commission', [ReportController::class,'export'])->name('commission.export');
