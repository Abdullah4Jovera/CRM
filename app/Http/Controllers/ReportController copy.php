...
//            $department->prepend('Select Department', '');
    ...
    public function leadreport(Request $request)
    {
        ...
        while ($currentdate <= $end) {
            ...
            if (!empty($request->start_month)) {
                $leadFilter = Lead::where('created_by', \Auth::user()->creatorId())->where('products',1)->whereNull('is_converted')->whereMonth('date', $request->start_month)->whereYear('date', $year)->get();
                $Bb[] = Lead::where('created_by', \Auth::user()->creatorId())->where('products',1)->whereNull('is_converted')->whereMonth('date', $request->start_month)->whereYear('date', $year)->count();
                $Pl[] = Lead::where('created_by', \Auth::user()->creatorId())->where('products',2)->whereNull('is_converted')->whereMonth('date', $request->start_month)->whereYear('date', $year)->count();
                $Ml[] = Lead::where('created_by', \Auth::user()->creatorId())->where('products',3)->whereNull('is_converted')->whereMonth('date', $request->start_month)->whereYear('date', $year)->count();
                ...
                $Bb[] = Lead::where('created_by', \Auth::user()->creatorId())->where('products',1)->whereNull('is_converted')->whereMonth('date', $month)->whereYear('date', $year)->count();
                $Pl[] = Lead::where('created_by', \Auth::user()->creatorId())->where('products',2)->whereNull('is_converted')->whereMonth('date', $month)->whereYear('date', $year)->count();
                $Ml[] = Lead::where('created_by', \Auth::user()->creatorId())->where('products',3)->whereNull('is_converted')->whereMonth('date', $month)->whereYear('date', $year)->count();
            }
    ...
    public function dealreport(Request $request)
    {
        ...
        while ($currentdate <= $end) {
            ...
            if (!empty($request->start_month)) {
                $dealFilter = Deal::where('contract_stage','cm_signed')->where('created_by', \Auth::user()->creatorId())->whereMonth('created_at', $request->start_month)->whereYear('created_at', $year)->get();
            } else {
                $dealFilter = Deal::where('contract_stage','cm_signed')->where('created_by', \Auth::user()->creatorId())->whereMonth('created_at', $month)->whereYear('created_at', $year)->get();
            }
