...
class LeadActivityLog extends Model
{
    ...
    public function getLeadRemark()
    {
        ...
        if($remark)
        {
            ...
            {
                return $user_name . " " . __('Moved lead') . " <b>" . $remark['title'] . "</b> " . __('from') . " " . __(ucwords($remark['old_status'])) . " " . __('to') . " " . __(ucwords($remark['new_status']));
            }
            elseif($this->log_type == 'Transfer Lead')
            {
                return $user_name . " " . __('Tranfer Lead') . " <b>" . $remark['title'] . "</b> " . __('from') . " " . __(ucwords($remark['old_status'])) . " " . __('to') . " " . __(ucwords($remark['new_status']));
            }
        }
        else
        {
