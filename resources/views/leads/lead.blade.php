                                        ...
                                        @if (empty($lead->is_converted))
                                            ...
                                            <div class="card" data-id="{{$lead->id}}">
                                                ...
                                                <div class="card-header border-0 pb-0 position-relative">
                                                    <h5><a href="@can('view lead')@if($lead->is_active){{route('leads.show',$lead->id)}}@else#@endif @else#@endcan">{{ optional($lead)->client_name ?? 'N/A'  }}</a></h5>
                                                        ...
                                                        @if(Auth::user()->type != 'client')
                                                            <div class="btn-group card-option">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-end">
                                                                    ...
                                                                    @can('edit lead')
                                                                        <a class="dropdown-item reject" data-value="{{ URL::to('leads/'.$lead->id.'/reject') }}"  data-bs-original-title="{{__('Reject Lead')}}">
                                                                            <i class="ti ti-ban"></i>
                                                ...
                                                <div class="card-body">
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        ...
                                                        <div class="d-flex align-items-center justify-content-between">
                                                            <div class="badge-xs mt-2 badge bg-primary fs-6 rounded">{{optional($lead->leadType)->name}} <br> {{optional($lead->source)->name}} </div>
                                                        </div>
