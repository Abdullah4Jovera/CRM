    ...
    <div class="float-end">
        @can('convert lead to deal')
            ...
            @else
                ...
                @endif
                <a href="#" data-size="lg" data-url="{{ URL::to('leads/'.$lead->id.'/show_convert') }}" data-ajax-popup="true" data-bs-toggle="tooltip" title="{{__('Contract Form')}}" class="btn btn-sm btn-primary">
                    <i class="ti ti-exchange"></i>
                </a>
