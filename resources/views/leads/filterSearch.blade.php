                                                    ...
                                                    <div class="card">
                                                        <div class="card-header">
                                                            <div class="float-end">
                                                                @php
                                                                    $count = 0;
                                                                    foreach ($new_leads as $ld) {
                                                                        for ($i=0; $i < count($searchLeads) ; $i++) {
                                                                        if ($new_lead_stage->id == $searchLeads[$i]->stage_id && $ld->id == $searchLeads[$i]->id) {
                                                                                $count++;
                                                                        }
                                                                        }
                                                                    }
                                                                                    ...
                                                                                    <div class="d-flex align-items-center justify-content-between">
                                                                                        ...
                                                                                        <div class="user-group">
                                                                                            @foreach($new_lead->users as $user)
                                                                                                @if($new_lead->created_by != $user->id && $user->designation != 'Jovera' && $user->type != 'company')
