        ...
        (function () {
            var chartBarOptions = {
                series: [
                    {
                    name: 'Signatured',
                    data: {!! json_encode($leadpipelineeData['Signatured']) !!},
                },
                    {
                    name: 'Submission',
                    data: {!! json_encode($leadpipelineeData['Submission']) !!},
                },
                    {
                    name: 'Approved',
                    data: {!! json_encode($leadpipelineeData['Approved']) !!},
                },
                    {
                    name: 'Rejected',
                    data: {!! json_encode($leadpipelineeData['Rejected']) !!},
                },
                    {
                    name: 'Disbursed',
                    data: {!! json_encode($leadpipelineeData['Disbursed']) !!},
                },
                    {
                    name: 'Collected',
                    data: {!! json_encode($leadpipelineeData['Collected']) !!},
                },
            ],
                ...
                xaxis: {
                    ...
                    title: {
                        text: '{{ __("Deal Stage By Pipelines") }}'
                    }
                },
                yaxis: {
                    title: {
                ...
                colors: ['#1E3888', '#47A8BD','#F5E663', '#FFAD69','#9C3848', '#BC2C1A'],
