<div class="form-group row">
    ...
    <div class="col-4 form-group">
        <select class="form-control select" name="business_banking_services" id="business_banking_services" required>
    ...
    <div class="col-4 form-group">
        {{ Form::text('company_name', null, array('class' => 'form-control company_name', 'placeholder'=>' Company Name')) }}
    </div>
    <div class="col-4 form-group">
