                        ...
                        <li class="dash-item dash-hasmenu
                                ...
                                <a href="#!" class="dash-link ">
                                    ...
                                    <ul class="dash-submenu">
                                        ...
                                        @if(\Auth::user()->show_hrm() == 1 && Gate::check('show hrm dashboard'))
                                        ...
                                        @if(\Auth::user()->show_crm() == 1 && Gate::check('show crm dashboard'))
                                            <li class="dash-item dash-hasmenu {{ ( Request::segment(1) == 'crm-dashboard' || Request::segment(1) == 'reports-lead' || Request::segment(1) == 'reports-commission' || Request::segment(1) == 'reports-deal') ? ' active dash-trigger' : ''}}">
                                                ...
                                                <ul class="dash-submenu">
                                                    @can('show crm dashboard')
                                                       ...
                                                       @if (\Auth::user()->designation == 'Jovera' || \Auth::user()->designation == 'HOD' || \Auth::user()->type == 'company' )
                                                         <li class="dash-item dash-hasmenu {{ ( Request::segment(1) == 'reports-lead' || Request::segment(1) == 'reports-commission' || Request::segment(1) == 'reports-deal') ? 'active dash-trigger' : ''}}"
                                                             href="#crm-report" data-toggle="collapse" role="button"
                                                             aria-expanded="{{( Request::segment(1) == 'reports-lead' || Request::segment(1) == 'reports-commission' || Request::segment(1) == 'reports-deal') ? 'true' : 'false'}}">
                                                             <a class="dash-link" href="#">{{__('Reports')}}<span class="dash-arrow"><i data-feather="chevron-right"></i></span></a>
                                                             <ul class="dash-submenu">
                                                                 <li class="dash-item {{ request()->is('reports-lead') ? 'active' : '' }}">
                                                                     <a class="dash-link" href="{{ route('report.lead') }}">{{__('Lead')}}</a>
                                                                 </li>
                                                                 <li class="dash-item {{ request()->is('reports-commission') ? 'active' : '' }}">
                                                                     <a class="dash-link" href="{{ route('report.commission') }}">{{__('Commission')}}</a>
                                                                 </li>
                                        ...
                                        @if(\Auth::user()->show_pos() == 1 && Gate::check('pos dashboard'))
                        ...
                        @if( Gate::check('manage lead') || Gate::check('manage deal') || Gate::check('manage form builder')  || Gate::check('manage contract'))
                            <li class="dash-item dash-hasmenu
                                        {{ (Request::segment(1) == 'stages' || Request::segment(1) == 'labels' || Request::segment(1) == 'sources' ||
                                            ...
                                            Request::segment(1) == 'leads'  || Request::segment(1) == 'form_builder' || Request::segment(1) == 'form_response' || Request::segment(1) == 'contract' || Request::segment(1) == 'clients')?' active dash-trigger':''}}">
                                ...
                                <ul class="dash-submenu
                                            {{ (Request::segment(1) == 'stages' || Request::segment(1) == 'labels' || Request::segment(1) == 'sources' ||
                                                ...
                                                Request::segment(1) == 'form_response' || Request::segment(1) == 'deals' || Request::segment(1) == 'pipelines'|| Request::segment(1) == 'clients')?'show':''}}">
                                    @can('manage lead')
                                        <li class="dash-item {{ ( Request::route()->getName() == 'leads.index' || Request::route()->getName() == 'leads.show') ? ' active' : '' }}">
                                    ...
                                    <li class="dash-item {{ (Request::route()->getName() == 'leads.clients' ) ? ' active' : '' }}">
                                        <a class="dash-link" href="{{ route('clients.index') }}">{{__('Client')}}</a>
                                    </li>
                                    <li class="dash-item {{ (Request::route()->getName() == 'leads.list' )}}">
                                            <a class="dash-link" href="{{route('leads.list')}}">{{__('Reject Leads')}}</a>
                                    </li>
                                    @if (\Auth::user()->designation == "Jovera" || \Auth::user()->designation == "HOD")
                                        <li class="dash-item {{ (Request::route()->getName() == 'leads.list' )}}">
                                                <a class="dash-link" href="{{route('deals.list')}}">{{__('Reject Deals')}}</a>
                                        </li>
                                    @endif
                                    {{-- @endcan --}}
