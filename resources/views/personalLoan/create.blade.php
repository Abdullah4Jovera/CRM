...
<div class="col-6 form-group">
    {{ Form::text('company_name', null, array('class' => 'form-control company_name','placeholder'=>' Company Name', 'required'=>'required')) }}
</div>
<div class="col-6 form-group">
    <input type="number" name="monthly_salary" id="monthly_salary" class="form-control" placeholder="Monthly Salary AED" >
</div>
<div class="col-4 form-group">
    {{ Form::text('load_amount', null, array('class' => 'form-control load_amount','placeholder'=>'Loan Amount')) }}
</div>
<div class="col-4 form-group">
...
<div class="col-4 form-group">
    {{ Form::number('taken_loan_amount', null, array('class' => 'form-control taken_loan_amount','placeholder'=>'Previous Loan Amount','disabled'=> '')) }}
</div>
